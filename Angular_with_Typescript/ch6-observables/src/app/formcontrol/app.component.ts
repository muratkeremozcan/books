...
(1.2)
! valueChanges: whenever the value of the form control changes, the underlying FormControl object emits an event
...
export class AppComponent {
  ...
  constructor() {
    ...
    // (1.2) once we hook up formControl, we can use valueChanges observable from Forms API
