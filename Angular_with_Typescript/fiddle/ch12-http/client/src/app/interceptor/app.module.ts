...
@NgModule({
  ...
  // (4.3) an interceptor is an injectable service, so declare its provider for the HTTP_INTERCEPTORS token in the @NgModu;le() decorator
  ...
  providers: [
    // (4.4) how to use an abstract class:  provide: abstract class, useClass: the real/implemented class
