...
var currency = require('./4_ES6_export_functions_atTheEnd'); // module within same directory
// the way to import is the same in  export varieties
console.log( currency.canadianToUS(50));
console.log( currency.usToCanadian(30));

import {canadianToUS, usToCanadian} from  './4_ES6_export_functions_atTheEnd';
