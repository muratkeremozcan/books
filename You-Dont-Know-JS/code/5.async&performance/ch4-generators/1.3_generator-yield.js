// additionally generators have an input/output messaging capability built into them, via yield and next(..)
...
// IMPORTANT: In general, you’re going to have one more next(..) call than you have yield statements
  // because the first next() is used to star the generator
