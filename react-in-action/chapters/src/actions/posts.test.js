...
describe("login actions", () => {
  ...
  test("createNewPost, success", async () => {
    // need to set the current user.id to create a post, because it is null upon initial state
  ...
  test("getPostsForPage, success", async () => {
    ...
    // pattern to mock links with jest
  ...
  test("loadPost, success", async () => {
    ...
    // pattern to mock functions from other components
